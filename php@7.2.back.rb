class PhpAT72 < Formula
  ...
  def install
    ...
    args = %W[
      --prefix=#{prefix}
      --localstatedir=#{var}/php/#{version.major_minor}/
    ...
    unless (var/"php/#{version.major_minor}/log/php-fpm.log").exist?
      (var/"php/#{version.major_minor}/log").mkpath
      touch var/"php/#{version.major_minor}/log/php-fpm.log"
    end
  end
  ...
  def post_install
    ...
    (var/"php/#{version.major_minor}/run").mkpath
    ...
    <<~EOS
      ...
      <plist version="1.0">
        <dict>
          ...
          <string>#{var}/php/#{version.major_minor}/run/</string>
          <key>StandardErrorPath</key>
          <string>#{var}/php/#{version.major_minor}/log/php-fpm.log</string>
        </dict>
      </plist>
    EOS
  end
  ...
  test do
    ...
    begin
      ...
      (testpath/"fpm.conf").write <<~EOS
        ...
        listen = #{var}/php/#{version.major_minor}/run/php-fpm.sock
        pm = dynamic
        pm.max_children = 5
        pm.start_servers = 2
