class Mysql < Formula
  ...
  url "https://mirrors.tuna.tsinghua.edu.cn/mysql/downloads/MySQL-5.7/mysql-boost-5.7.33.tar.gz"
  ...
  def post_install
    # Make sure the var/data/mysql directory exists
    (var/"data/mysql").mkpath
