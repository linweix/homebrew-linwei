class PythonAT37 < Formula
  ...
  url "http://127.0.0.1/static/python/Python-3.7.7.tar.xz"
  ...
  resource "setuptools" do
    url "http://127.0.0.1/static/python/setuptools-46.0.0.zip"
    sha256 "2f00f25b780fbfd0787e46891dcccd805b08d007621f24629025f48afef444b5"
  end

  resource "pip" do
    url "http://127.0.0.1/static/python/pip-20.0.2.tar.gz"
    sha256 "7db0c8ea4c7ea51c8049640e8e6e7fde949de672bfa4949920675563a5a6967f"
  end

  resource "wheel" do
    url "http://127.0.0.1/static/python/wheel-0.34.2.tar.gz"
